...
import Testimonials from './settingsMiniComponents/Testimonials';
  ...
  return (
    ...
    <Container fluid className='ml-[2%] md:ml-[2%] w-[95%] sm:w-[96%]  px-4 py-4 z-0 flex flex-col items-start bg-white rounded-3xl'>
          ...
          <div className='flex items-center gap-x-3'>
            ...
            <h4 className='flex items-center'><MdKeyboardArrowLeft className='rotate-180 text-[#767878]' size={18} /><span className='ml-1 '>Settings</span><MdKeyboardArrowLeft className='rotate-180 text-[#767878]' size={18} /><span className='ml-1 font-semibold'>Testimonials Setting</span></h4>
          </div>
        </div>
