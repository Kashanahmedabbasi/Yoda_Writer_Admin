  ...
  [
    {
     id: 0,
     sl: 1,
     image: "https://www.signaturemaker.in/yodawriteai/storage/files/Brand/1679112829.svg",
     name: 'auto speed',
     status: 'Active',
     action: '',
    },
    {
      id: 1,
      sl: 2,
      image: "https://www.signaturemaker.in/yodawriteai/storage/files/Brand/1679112849.svg",
      name: 'baby swim',
      status: 'Active',
      action: '',
     },
     {
      id: 2,
      sl: 3,
      image: "https://www.signaturemaker.in/yodawriteai/storage/files/Brand/1679112864.svg",
      name: 'beauty box',
      status: 'Active',
      action: '',
     },
     {
      id: 3,
      sl: 4,
      image: "https://www.signaturemaker.in/yodawriteai/storage/files/Brand/1679112875.svg",
      name: 'crofts',
      status: 'Active',
      action: '',
     },
     {
      id: 4,
      sl: 5,
      image: "https://www.signaturemaker.in/yodawriteai/storage/files/Brand/1679112889.svg",
      name: 'greens food',
      status: 'Active',
      action: '',
     },
     {
      id: 5,
      sl: 6,
      image: "https://www.signaturemaker.in/yodawriteai/storage/files/Brand/1679112905.svg",
      name: 'peters blinds',
      status: 'Active',
      action: '',
     },
     {
      id: 6,
      sl: 7,
      image: "https://www.signaturemaker.in/yodawriteai/storage/files/Brand/1679112937.svg",
      name: 'space cube',
      status: 'Active',
      action: '',
     },
     {
      id: 7,
      sl: 8,
      image: "https://www.signaturemaker.in/yodawriteai/storage/files/Brand/1679112951.svg",
     ...
     },
     {
      id: 8,
      sl: 9,
      image: "https://www.signaturemaker.in/yodawriteai/storage/files/Brand/1679112965.svg",
      name: 'the web works',
      status: 'Active',
      action: '',
     },
     {
      id: 9,
      sl: 10,
      image: "https://www.signaturemaker.in/yodawriteai/storage/files/Brand/1679112979.svg",
      name: 'yoga baby',
      status: 'Active',
      action: '',
     },
   ...
   const columns = [
    ...
    renderCell: (params) => ( 
     <img src={params.value} alt="" className={`${params.value === '' ? 'hidden' : 'h-20 w-20 rounded-lg'} `} />) },
