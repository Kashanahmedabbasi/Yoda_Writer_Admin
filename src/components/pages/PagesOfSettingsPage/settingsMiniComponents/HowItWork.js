...
import AddnEditModalHOW from '../../../modal/AddnEditModalHOW';
  ...
  [
    {
     id: 0,
     sl: 1,
     image: "https://www.signaturemaker.in/yodawriteai/storage/files/HowItWork/1679509825.jpg",
     name: 'AI Assistant',
     status: 'Active',
     action: '',
     bgColor: '#C2E8FF',
    },
    {
      id: 1,
      sl: 2,
      image: "https://www.signaturemaker.in/yodawriteai/storage/files/HowItWork/1679510026.png",
      name: 'Describe',
      status: 'Active',
      action: '',
      bgColor: '#CC4243',
     },
     {
      id: 2,
      sl: 3,
      image: "https://www.signaturemaker.in/yodawriteai/storage/files/HowItWork/1679510911.png",
   ...
   const columns = [
    ...
    renderCell: (params) => ( 
     <img src={params.value} alt="" className={`${params.value === '' ? 'hidden' : 'h-14 w-14 rounded-lg'} `} />) },
     { field: 'bgColor', headerName: 'Background Color', flex: iswidth ? undefined : 1, 
     width: iswidth ? 120 : undefined,  
    renderCell: (params) => ( 
        <span className={`h-7 w-7  rounded-lg`} style={{ backgroundColor: `${params.value}`}}></span>) },
...
const toggleEditModal = (selectedRow) => {
  ...
  setEditedColor(selectedCategory.bgColor);
  ...
  return (
    ...
    <button  className='px-4 py-3 font-semibold text-white bg-blue-500 rounded-lg ' onClick={toggleAddModal}>Add How It Works</button>
    </div>
    {/* table Container*/}
    ...
    <AddnEditModalHOW  button={'Update'} heading={'Edit'} isToggle={editModal} setIsToggle={setEditModal} handlerFunction={handleEdit} name={editedName} status={editedStatus}  setCategory={setEditedLanguage} setName={setEditedName} setImage={setEditedImage} image={editedImage} color={editedColor} setColor={setEditedColor}   setStatus={setEditedStatus}/>
    <AddnEditModalHOW  button={'Add'}    heading={'Add'} isToggle={addModal} setIsToggle={setAddModal} handlerFunction={handleAdd} name={addedName} status={addedStatus}  setCategory={setAddedLanguage} setName={setAddedName} setImage={setAddedImage} image={addedImage}           color={addedColor} setColor={setAddedColor}   setStatus={setAddedStatus}/>
