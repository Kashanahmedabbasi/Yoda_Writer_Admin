...
import ShowHide from './settingsMiniComponents/ShowHide';
...
const ShowHidePage = () => {
  ...
  return (
    ...
    <Container fluid className='ml-[2%] md:ml-[2%] w-[95%] sm:w-[96%]  px-4 py-4 z-0 flex flex-col items-start bg-white rounded-3xl'>
          ...
          <h2 className='text-2xl font-semibold'>Home Section Setting</h2>
          <div className='flex items-center gap-x-3'>
            <h4 className='text-[#767878]'>Dashboard</h4>
            <h4 className='flex items-center'><MdKeyboardArrowLeft className='rotate-180 text-[#767878]' size={18} /><span className='ml-1 font-semibold'>Home Section Setting</span></h4>
          </div>
        </div>
