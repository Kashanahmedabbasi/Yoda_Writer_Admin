...
const AddnEditModalBrand = (props) => {
  const {isToggle, setIsToggle,  name, status, handlerFunction, setName, image, setImage,  setStatus ,heading, button} = props;
...
export default AddnEditModalBrand